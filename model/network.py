...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.compress = ResBlock(768, 512)
...
class STCN(nn.Module):
    def __init__(self, single_object):
        ...
        self.key_encoder = KeyEncoder()   # ResNet50--layer3
        if single_object:
            self.value_encoder = ValueEncoderSO() 
        else:
            self.value_encoder = ValueEncoder()  # ResNet18--layer3

        # Projection from f16 feature space to key space
        self.key_proj = KeyProjection(1024, keydim=64)    # one conv
    ...
    def segment(self, qk16, qv16, qf8, qf4, mk16, mv16, selector=None): 
        ...
        # segment a specific frame
        affinity = self.memory.get_affinity(mk16, qk16) # mk16: bs, 64, T, 24, 24; qk16: bs, 64, 24, 24; affinity: bs, THW, THW
